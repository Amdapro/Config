...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/3kjTbXm/King-Amda-v2-2.jpg' : process.env.ALIVE_LOGO,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://i.ibb.co/3kjTbXm/King-Amda-v2-2.jpg' : process.env.MENU_LOGO,
    ...
    DECODE: process.env.DECODE === undefined ? '404Api' : process.env.DECODE,
